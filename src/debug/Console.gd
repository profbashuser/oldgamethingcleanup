...
@onready var input_box = get_node("Window/LineEdit")
@onready var output_box = get_node("Window/ConsoleLabel")
@onready var command_handler = get_node("Window/Handle")
...
# func goto_command_history(hoffset):
# 	commandhistoryline += hoffset
